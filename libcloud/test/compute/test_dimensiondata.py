...
class DimensionDataTests(unittest.TestCase, TestCaseMixin):
    ...
    def test_node_extras(self):
        ...
        self.assertTrue(
            isinstance(ret[0].extra['disks'][0], DimensionDataServerDisk))
        self.assertEqual(ret[0].extra['disks'][0].size_gb, 10)
        self.assertTrue(isinstance(ret[1].extra['disks'], list))
        self.assertTrue(
            isinstance(ret[1].extra['disks'][0], DimensionDataServerDisk))
    ...
    # See
    # _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_server_ALLFILTERS for asserts
    def test_list_nodes_response_strings_ALLFILTERS(self):
        ...
        ret = self.driver.list_nodes(ex_location='fake_loc',
                                     ex_name='fake_name',
                                     ex_ipv6='fake_ipv6', ex_ipv4='fake_ipv4',
                                     ex_vlan='fake_vlan',
        ...
        self.assertTrue(
            isinstance(node.extra['disks'][0], DimensionDataServerDisk))
    ...
    def test_create_node_response_mcp1(self):
    ...
    def test_create_node_optional_param_mcp1(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        network = self.driver.ex_list_networks()[0]
    ...
    def test_create_node_response_no_pass_random_gen_mcp1(self):
        image = self.driver.list_images()[0]
        network = self.driver.ex_list_networks()[0]
    ...
    def test_create_node_response_no_pass_customer_windows_mcp1(self):
    ...
    def test_create_node_response_no_pass_customer_windows_STR_mcp1(self):
    ...
    def test_create_node_response_no_pass_customer_linux_mcp1(self):
    ...
    def test_create_node_response_no_pass_customer_linux_STR_mcp1(self):
    ...
    def test_create_node_response_STR_mcp1(self):
        rootPw = 'pass123'
    ...
    def test_create_node_response_network_domain_legacy(self):
        rootPw = NodeAuthPassword('pass123')
    ...
    def test_create_node_response_network_domain_STR_legacy(self):
        rootPw = NodeAuthPassword('pass123')
        location = self.driver.ex_get_location_by_id('NA9')
        image = self.driver.list_images(location=location)[0]
        network_domain = \
    ...
    def test_create_node_no_network_mcp1_fail(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
    ...
    def test_create_node_ipv4_mcp1(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
    ...
    def test_create_node_network_mcp1(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        node = self.driver.create_node(name='test2',
                                       image=image,
    ...
    def test_create_node_vlan_legacy(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        node = self.driver.create_node(name='test2',
                                       image=image,
    ...
    def test_create_node_ipv4_legacy(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        node = self.driver.create_node(name='test2',
                                       image=image,
    ...
    def test_create_node_additional_nics_legacy(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
    ...
    def test_create_node_bad_additional_nics_ipv4_legacy(self):
        root_pw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        with self.assertRaises(TypeError):
            self.driver.create_node(name='test2',
    ...
    def test_create_node_bad_additional_nics_vlan_legacy_fail(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        with self.assertRaises(TypeError):
            self.driver.create_node(name='test2',
    ...
    def test_create_node_additional_nics_vlan_ipv4_not_exist_fail(self):
        root_pw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        nic1 = DimensionDataNic(network_adapter='v1000')
        nic2 = DimensionDataNic(network_adapter='v1000')
        additional_nics = [nic1, nic2]
        with self.assertRaises(ValueError):
            self.driver.create_node(name='test2',
                                    image=image,
    ...
    def test_create_node_indicate_dns(self):
        rootPw = NodeAuthPassword('pass123')
        image = self.driver.list_images()[0]
        node = self.driver.create_node(name='test2',
                                       image=image,
    ...
    def test_ex_list_network_domains_ALLFILTERS(self):
        DimensionDataMockHttp.type = 'ALLFILTERS'
        nets = self.driver.ex_list_network_domains(location='fake_location',
                                                   name='fake_name',
    ...
    def test_ex_list_vlans_ALLFILTERS(self):
        DimensionDataMockHttp.type = 'ALLFILTERS'
        vlans = self.driver.ex_list_vlans(location='fake_location',
    ...
    def test_ex_get_vlan(self):
        ...
        self.assertEqual(vlan.ipv6_range_address,
                         '2607:f480:1111:1153:0:0:0:0')
    ...
    def test_ex_get_nat_rule(self):
        net = self.driver.ex_get_network_domain(
            '8cdfd607-f429-4df6-9352-162cfc0891be')
        rule = self.driver.ex_get_nat_rule(net,
                                           '2187a636-7ebb-49a1-a2ff-5d617f496dce')
    ...
    def test_ex_clone_node_to_image(self):
        node = self.driver.list_nodes()[0]
        result = self.driver.ex_clone_node_to_image(node, 'my image',
                                                    'a description')
        self.assertTrue(result)

    def test_ex_update_node(self):
        node = self.driver.list_nodes()[0]
        result = self.driver.ex_update_node(node, 'my new name',
                                            'a description', 2, 4048)
        self.assertTrue(result)

    def test_ex_reconfigure_node(self):
        node = self.driver.list_nodes()[0]
        result = self.driver.ex_reconfigure_node(node, 4, 4, 1,
                                                 'HIGHPERFORMANCE')
        self.assertTrue(result)
    ...
    def test_ex_create_anti_affinity_rule_FAIL_EXISTING(self):
        ...
        with self.assertRaises(DimensionDataAPIException):
            self.driver.ex_create_anti_affinity_rule(
                (node_list[0], node_list[1]))
    ...
    def test_ex_get_tag_by_id(self):
        tag = self.driver.ex_get_tag_key_by_id(
            'd047c609-93d7-4bc5-8fc9-732c85840075')
    ...
    def test_ex_get_tag_by_id_NOEXIST(self):
        ...
        with self.assertRaises(DimensionDataAPIException):
            self.driver.ex_get_tag_key_by_id(
                'd047c609-93d7-4bc5-8fc9-732c85840075')
    ...
    def test_ex_modify_tag_key_NOTNAME(self):
        ...
        success = self.driver.ex_modify_tag_key(tag_key, description='NewDesc',
                                                value_required=False,
    ...
    def test_summary_usage_report(self):
        report = self.driver.ex_summary_usage_report('2016-06-01',
                                                     '2016-06-30')
    ...
    def test_detailed_usage_report(self):
        report = self.driver.ex_detailed_usage_report('2016-06-01',
                                                      '2016-06-30')
        report_content = report
...
class DimensionDataMockRawResponse(MockRawResponse):
    ...
    def _oec_0_9_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_report_usage(self,
                                                                   method, url,
                                                                   body,
                                                                   headers):
...
class DimensionDataMockHttp(StorageMockHttp, MockHttp):
    ...
    def _oec_0_9_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_deployed(self,
                                                                      method,
                                                                      url,
                                                                      body,
                                                                      headers):
    ...
    def _oec_0_9_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_datacenter(self, method,
                                                                 url, body,
                                                                 headers):
        body = self.fixtures.load(
    ...
    def _oec_0_9_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_11(self, method,
                                                                url, body,
                                                                headers):
        body = None
        action = url.split('?')[-1]
    ...
    def _oec_0_9_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server(self, method, url,
                                                             body, headers):
        body = self.fixtures.load(
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_server_ALLFILTERS(
        ...
        for parameter in parameters:
            ...
            if key == 'datacenterId':
                ...
                raise ValueError(
                    "Could not find in url parameters {0}:{1}".format(key,
                                                                      value))
        body = self.fixtures.load(
            'server_server.xml')
        return (httplib.OK, body, {}, httplib.responses[httplib.OK])
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_startServer(self,
                                                                          method,
                                                                          url,
                                                                          body,
                                                                          headers):
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_resetServer(self,
                                                                          method,
                                                                          url,
                                                                          body,
                                                                          headers):
        ...
        if network is not None:
            if network_info is not None:
                raise InvalidRequestError(
                    "Request has both MCP1 and MCP2 values")
            ...
            if ipv4 is None and networkId is None:
                raise InvalidRequestError(
                    'Invalid request MCP1 requests need privateIpv4 or '
                    'networkId')
            ...
            raise InvalidRequestError(
                'Invalid request, does not have network or network_info in '
                'XML')
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_network_deployVlan(self,
                                                                          method,
                                                                          url,
                                                                          body,
                                                                          headers):
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_network_deleteVlan(self,
                                                                          method,
                                                                          url,
                                                                          body,
                                                                          headers):
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_network_expandVlan(self,
                                                                          method,
                                                                          url,
                                                                          body,
                                                                          headers):
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_server_cleanServer(self,
                                                                          method,
                                                                          url,
                                                                          body,
                                                                          headers):
    ...
    def _caas_2_3_8a8f6abc_2745_4d8a_9cbc_8dabe5a7d0e4_tag_tagKey(self, method,
                                                                  url, body,
                                                                  headers):
        body = self.fixtures.load(
            'tag_tagKey_list.xml'
